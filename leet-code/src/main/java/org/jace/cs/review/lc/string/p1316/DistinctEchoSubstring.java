package org.jace.cs.review.lc.string.p1316;
...
public class DistinctEchoSubstring {
    ...
    public static void main(String[] args) {
        DistinctEchoSubstring des = new DistinctEchoSubstring();

        System.out.println(des.distinctEchoSubstrings("abcabcabc"));

        System.out.println(des.distinctEchoSubstrings("leetcodeleetcode"));
